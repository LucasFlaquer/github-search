...
interface GithubCornerInterface{
  address: string;
  primary: string;
}

const GithubCorner: React.FC<GithubCornerInterface> = ({address, primary}) => {
  return (
    <a href={address} className="github-corner" target="_blank" rel="noopener noreferrer">
      <svg
        xmlns="http://www.w3.org/2000/svg" width="80" height="80"
        viewBox="0 0 250 250" fill="#232324">
        <path d="M0 0l115 115h15l12 27 108 108V0z" className="github-corner__background" fill={primary}/>
